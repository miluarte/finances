    ...
    <div className="space-y-6">
      ...
      {isAdmin && summary?.cards?.length > 0 && (
        <div className="space-y-3">
          <h2 className="font-semibold">Cartoes</h2>
              ...
              <Card key={card.id}>
                <CardContent className="pt-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Limite disponivel estimado: {formatCurrency(limit - used)}
                  </p>
                  {limitWarning && (
                    <Alert variant="warning" className="py-2">
                      <AlertTriangle className="h-4 w-4" />
                      <AlertTitle className="text-xs font-semibold">Atencao</AlertTitle>
                      <AlertDescription className="text-xs">
                        Mais de {Math.round(ratio * 100)}% do limite utilizado.
                      </AlertDescription>
                    </Alert>
                  )}
                </CardContent>
